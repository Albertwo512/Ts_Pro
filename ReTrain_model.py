...
mel_dir_train = "Numero frances dataset/mels"  # Datos para las 3 clases (0, 1, 2)
...
# Cargar el modelo previamente entrenado con clases 0 y 1
model_path = "R-M-v0.pth"  # Modelo previamente entrenado con 0 y 1
...
save_model(model, "R-M-FINAL-v1.pth")
